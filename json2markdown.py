...
def main() -> int:
    ...
    try:
        ...
        repair_model: str = args.model
        repair_status = "not used (no --context provided)"
        ...
        lines.append(f"- Second-pass repair model: {repair_model}")
        lines.append(f"- Second-pass repair status: {repair_status}")
        if repair_context_path:
